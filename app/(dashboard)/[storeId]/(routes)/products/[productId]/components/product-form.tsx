                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <ImageUpload
                                ...
                                onRemove={(url) => field.onChange([...field.value.filter(currentImg => currentImg.url !== url)])}
                            />
                        </FormControl>
                        <FormMessage/>
                    </FormItem>
                    ...
                    <FormField control={form.control} name="isArchived" render={({field}) => (
                        <FormItem className='flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4'>
                            ...
                            <div className='space-y-1 leading-none'>
                                ...
                                <FormDescription>This product will not apper anywhere in the store</FormDescription>
                            </div>
                        </FormItem>
                    )}/>
                </div>
